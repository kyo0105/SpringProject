...
public class NaverLoginBO {
    ...
    private static final String CLIENT_ID = "your-naver-client-id";
    private static final String CLIENT_SECRET = "your-naver-client-secret";
    ...
    /* 네이버 아이디 로그인 Callback 처리 및 AccessToken 획득 */
